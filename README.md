...
- [nilsreichardt/AnkiGPT](https://github.com/nilsreichardt/AnkiGPT) - Turn lecture slides into flashcards and export them to Anki. Uses GPT-4 by OpenAI. AnkiGPT already generated 2,422,728 flashcards.
...
- [mrusme/overpush](https://github.com/mrusme/overpush) - A self-hosted, drop-in replacement for Pushover, that  uses XMPP as delivery method and offers the same API for submitting messages, so  that existing setups (e.g. Grafana) can continue working and on
...
- [BrowserBoost/Extension](https://github.com/BrowserBoost/Extension) - This extension has been sold and is no longer maintained. Current version on webstore may contain malware. - Browser extension to boost volume, change user agent, enable right click, copy & select, di
...
- [dclstn/better-snapchat](https://github.com/dclstn/better-snapchat) - Screenshot Freely, Save Media, Bypass Presence Detection and more! Previously known as Better Snapchat.
