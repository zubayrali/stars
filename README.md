...
- [nilsreichardt/AnkiGPT](https://github.com/nilsreichardt/AnkiGPT) - Turn lecture slides into flashcards and export them to Anki. Uses GPT-4 by OpenAI. AnkiGPT already generated 2,364,274 flashcards.
- [KRTirtho/spotube](https://github.com/KRTirtho/spotube) - 🎧 Open source Spotify client that doesn't require Premium nor uses Electron! Available for both desktop & mobile!
- [krille-chan/fluffychat](https://github.com/krille-chan/fluffychat) - The cutest instant messenger in the [matrix]
- [jakubslaby09/dpc](https://github.com/jakubslaby09/dpc) - A czech app for managing a family chronicle using Git
...
- [hikmat2337/rssnix](https://github.com/hikmat2337/rssnix) - Unix-style filesystem-based RSS/Atom/JSON Feed fetcher/reader
...
- [readium/readium-css](https://github.com/readium/readium-css) - 🌈 A set of reference stylesheets for EPUB Reading Systems, starting with Readium Mobile
...
- [readium/desktop](https://github.com/readium/desktop) - Readium Desktop is an SDK for ebooks, audiobooks and comics written in Typescript and using node.js and Electron.js.
...
- [wa3dbk/ScribeSalad](https://github.com/wa3dbk/ScribeSalad) - A collection of YouTube videos transcripts : Podcasts (Joe Rogan Experience, Tim Ferris, Jocko podcast, ..), lectures (YaleCourses, MIT lectures, Jordan B. Peterson talks, ..). A big transcripts salad
...
- [rhyolite-org/rhyolite](https://github.com/rhyolite-org/rhyolite) - A simple text editor written in Rust using Tauri and svelte for frontend, inspired by Obsidian.  Discord:- https://discord.gg/K6FAd8FTma
...
- [danielmiessler/harness](https://github.com/danielmiessler/harness) - A tool for testing the efficacy of prompts and prompt + model combinations.
...
- [TheExacc/spotify-adblock-linux](https://github.com/TheExacc/spotify-adblock-linux) - script for installing spotify-adblock for ubuntu and popOS based machines
...
- [Quorafind/Obsidian-Task-Genius](https://github.com/Quorafind/Obsidian-Task-Genius) - Comprehensive task management plugin for Obsidian with progress bars, task status cycling, and advanced task tracking features.
...
- [tszhong0411/honghong.me](https://github.com/tszhong0411/honghong.me) - My personal website built with TypeScript, Next.js, and TailwindCSS
